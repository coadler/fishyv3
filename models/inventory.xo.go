...
type Inventory struct {
	...
	Fish      sql.NullInt64 `json:"fish"`      // fish
	Garbage   sql.NullInt64 `json:"garbage"`   // garbage
	Legendary sql.NullInt64 `json:"legendary"` // legendary
	Worth     sql.NullInt64 `json:"worth"`     // worth
