...
func (m *LocationsRequest) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_LocationsRequest.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalTo(b)
		if err != nil {
...
func (m *FishRequest) GetUser() string {
	if m != nil {
		return m.User
	}
	return ""
...
func init() {
	...
	proto.RegisterType((*LocationsRequest)(nil), "fishyv3.LocationsRequest")
	proto.RegisterType((*LocationsResponse)(nil), "fishyv3.LocationsResponse")
...
func (c *fishyClient) Locations(ctx context.Context, in *LocationsRequest, opts ...grpc.CallOption) (*LocationsResponse, error) {
	out := new(LocationsResponse)
	err := c.cc.Invoke(ctx, "/fishyv3.Fishy/Locations", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _Fishy_Locations_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(LocationsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(FishyServer).Locations(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/fishyv3.Fishy/Locations",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(FishyServer).Locations(ctx, req.(*LocationsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Fishy_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _Fishy_Locations_Handler,
		},
		{
...
func (m *LocationsResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Locations) > 0 {
		...
		dAtA[i] = 0xa
		i++
		i = encodeVarintFishy(dAtA, i, uint64(j3))
...
func (m *GetBaitInventoryResponse) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Bait != nil {
		...
		n5, err := m.Bait.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n5
...
func (m *UserItem) MarshalTo(dAtA []byte) (int, error) {
	...
	if len(m.Owned) > 0 {
		dAtA7 := make([]byte, len(m.Owned)*10)
		var j6 int
		...
		dAtA[i] = 0x12
		i++
		i = encodeVarintFishy(dAtA, i, uint64(j6))
...
func (m *UserItems) MarshalTo(dAtA []byte) (int, error) {
	...
	if m.Bait != nil {
		...
		i++
		i = encodeVarintFishy(dAtA, i, uint64(m.Bait.Size()))
		n8, err := m.Bait.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n8
	...
	if m.Hook != nil {
		...
		n10, err := m.Hook.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n10
	...
	if m.Vehicle != nil {
		...
		n11, err := m.Vehicle.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n11
	...
	if m.BaitBox != nil {
		...
		n12, err := m.BaitBox.MarshalTo(dAtA[i:])
		if err != nil {
			return 0, err
		}
		i += n12
